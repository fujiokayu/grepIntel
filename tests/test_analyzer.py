...
"""
        ...
        results = self.analyzer.parse_batch_response(
            batch_response, extractions, "test.java", "java", "en"
        )
...
"""
        ...
        results = self.analyzer.analyze_vulnerabilities_batch(
            extractions, "test.java", "java", "en"
        )
            ...
            mock_batch.return_value = [
                {
                    ...
                    "line_number": 10,
                    "pattern": "executeQuery\\s*\\(\\s*.*\\+.*\\)",
                    "code_context": extraction_results["results"][0]["extractions"][0][
                        "context"
                    ],
                    "explanation": "SQL injection vulnerability",
                    "impact": "Data breach",
                ...
                },
                {
                    ...
                    "line_number": 20,
                    "pattern": "response\\.getWriter\\(\\)\\.print\\s*\\(\\s*.*request\\.getParameter.*\\)",
                    "code_context": extraction_results["results"][0]["extractions"][1][
                        "context"
                    ],
                    "explanation": "Not vulnerable",
                    "impact": "",
