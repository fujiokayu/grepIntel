...
class ReportGenerator:
    ...
    def __init__(self, template_dir: Optional[str] = None):
        ...
        logger.debug(f"Initialized report generator with template directory: {template_dir}")
    
    def generate(self, analysis_results: Dict[str, Any], output_file: str, language: str = 'en') -> None:
        """
    ...
    def format_report(self, template: str, analysis_results: Dict[str, Any], 
        ...
        # Statistics
        report = report.replace("{high_severity_count}", str(statistics["high_severity"]))
        report = report.replace("{medium_severity_count}", str(statistics["medium_severity"]))
        report = report.replace("{low_severity_count}", str(statistics["low_severity"]))
        report = report.replace("{false_positive_count}", str(statistics["false_positives"]))
    ...
    def generate_summary(self, analysis_results: Dict[str, Any], 
                        statistics: Dict[str, Any]) -> str:
        """
    ...
    def generate_findings(self, analysis_results: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Generate vulnerability findings
        ...
        for file_result in analysis_results["results"]:
            ...
            for vulnerability in file_result["vulnerabilities"]:
                ...
                finding = {
                    ...
                    "vulnerability_title": vulnerability["vulnerability_type"].replace("_", " ").title(),
